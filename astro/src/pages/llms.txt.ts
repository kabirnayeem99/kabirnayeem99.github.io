...
export function GET(): Response {
  ...
  const lines = [
    ...
    `- [Agent Skills](${baseUrl}/.well-known/agent-skills.json): Enumerated HTTP skills for AI agents.`,
    `- [Agent Card](${baseUrl}/.well-known/agent-card.json): A2A agent card (informational).`,
    "",
    "## Markdown Mirrors",
    `- [All pages (full)](${baseUrl}/llms-full.txt): All main pages concatenated as Markdown.`,
